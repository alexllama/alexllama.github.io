...
For this one I combined the Starbucks logo with the Brockport Blue Devils logo.
{{< figure src="BportStarbucks.jpg" caption="" >}}
...
The second computer I ever had was a Commodore 64, which I used mostly for gaming, but I also spent quite a lot of hours doing BASIC programming. By programming I mean I would buy books with a bunch of programs, then spend hours retyping them to get them to run. One time my sister and I spent untold hours programming the computer to play the chorus for A-Ha's "Take on Me"...good times.
{{< figure src="c64.jpg" caption="" >}}

I saw a few folks online make this design but without the Nike symbol for obvious reasons...so I made my own.
{{< figure src="linux.jpg" caption="" >}}

This one is for my computer nerd friends. Rochester, NY is known as the Flower City, but it is also known as the Flour City. There's a history there, Google it. I wanted to make a shirt to reflect both names without being repetitive. The clear answer was to use a regular expression! This particular one returns true only for Flour or Flower. Then I added City plus Rochester's logo. In hindsight, the 'o' is redundant since it appears in both conditions. It should be '^Flo(u|we)r$', but I'm not making another shirt. 
{{< figure src="flowercity.jpg" caption="" >}}

Continuing with Rochester, I always thought the city has a great marketing team. The logo supposedly combines a lilac and a water wheel to represent two of Rochester's nicknames: Flower City and Flour City (see above for another shirt inspired by this). I always thought the logo looked inspired by the Quicksilver logo, and that if you cut one of the sides you could make it look like a wave. This is where I got the idea for the Rochester Surf Co. I made the shirt as a joke, since there are zero waves on Lake Ontario. Most of the time it goes unnoticed, but a couple of people have stopped me and asked about the surf club.
{{< figure src="rocsurfco.jpg" caption="" >}}

As you may have been able to tell from this website, I have made a number of cigar box guitars. There used to be a club in New York City called CBGB that was instrumental in the development of Punk and New Wave music in the 70's and 80's. Their logo was an acronym for "Country, Bluegrass, Blues" and was all over the place. The original logo also had these additional letters under the CBGB banner that read OMFUG, which stood for "Other Music For Uplifting Gourmandizers." It just so happens that the first three letters of the logo are CBG, so I had to make a shirt with the same iconic font. But what to replace the OMFUG with? I went with "OIMFJ", which stands for "Other Instruments Made From Junk."
{{< figure src="cbg.jpg" caption="" >}}

This is the first shirt I made. Sunn O))) is a band that plays ambient drone metal. It's difficult to describe, just go listen to it if you want to be put in a trance by very loud distortied guitars with long, drawn out chords and no beats, played by a couple of guys wearing robes and hoods surrounded by smoke.
{{< figure src="sunn.jpg" caption="" >}}

As an avid fan of Metallica since my early teens, and an enjoyer of math, this seemed like the perfect shirt to make. Note that I wrote it in Spanish so it would end in "ica" to better fit the logo.
{{< figure src="matematica.jpg" caption="" >}}

I always would wear a Misfits shirt for Halloween, but the one I used to own, um, shrunk in the dryer and doesn't fit anymore. So I made this one, with the original Fiend Club design, which you don't see very often these days.
{{< figure src="misfits.jpg" caption="" >}}
...
This one shows the spools of a cassette. Kids, ask your grandparents what a cassette is, or ask ChatGPT.
{{< figure src="cassette.jpg" caption="" >}}
...
I attended every Maker Faire in Rochester since it started as a Mini Maker Faire in 2014 until 2024, when my kids stopped being interested and the event turned more into an opportunity for people to sell handmade soaps and other crafts. Their shirt selection has never been that great, so I made this one with the Make Magazine mascot.
